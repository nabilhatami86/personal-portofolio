    ...
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            Studied here from Class 1 to 3th as a part of secondary school
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          <h4 className="vertical-timeline-element-title">
            DIPLOMA IN INFORMATIC ENGINEERING
          </h4>
          <h4 className="vertical-timeline-element-subtitle mt-2">
            Universitas Nahdlatul Ulama Indonesia, Jakarta
          </h4>
          <p>
            Studied Diploma in Informatic Engineer from Universitas Nahdlatul Ulama Indonesia and gain CGPA 3.77.
          </p>
        </VerticalTimelineElement>
        {/* <VerticalTimelineElement
          className="vertical-timeline-element--work"
