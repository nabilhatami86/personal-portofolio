      ...
      <VerticalTimeline>
        ...
        >
          <h5 className="vertical-timeline-element-title">
            PPM (Pengenalan Profesi Mahasiswa)
          </h5>
          <h6 className="vertical-timeline-element-subtitle mt-2">
            Keuangan Inklusif & Keuangan Syariah KEMENKO
          </h6>
          <p>• Melakukan input data yang berkaitan dengan administrasi program PPM secara sistematis dan terstruktur.</p>
          <p>• Menyusun dan mencatat notulensi rapat untuk mendokumentasikan hasil diskusi dan keputusan yang diambil selama rapat berlangsung.</p>
          <p>• Merancang dan mengembangkan website untuk memfasilitasi informasi terkait program PPM serta mempermudah akses peserta terhadap materi dan pengumuman penting.</p>
        </VerticalTimelineElement>
        {/* <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
